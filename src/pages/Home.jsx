        ...
        <>
            ...
            <div className="carousel w-full h-screen">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="./src/assets/images/stride-hero-bg.jpg" className="w-full" />
            ...
            <section>
                <div className="section_title">
                    <h1 className="font-bold text-center text-5xl my-5">Featured Products</h1>
                </div>
            ...
            <section className="mt-4">
                {/** Hero */}
                <div className="hero w-full" style={backgroundStyle}>
